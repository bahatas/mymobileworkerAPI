...
insert into jobs(created_at, is_deleted, updated_at, delivery_date, delivery_time, description, job_referenceo, location, status, client_id, driver_rider_id) VALUES
